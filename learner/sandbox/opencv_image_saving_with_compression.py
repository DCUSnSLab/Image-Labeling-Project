...
image = cv2.imread(IMAGE_PATH_PNG) # 상대경로 먹힘 !!!. 상대경로따윈 더이상 믿지 않는다...! 여태 내가 상대경로 시작위치를 잘못알고 있었어 ;ㅁ;!... 이미지 로딩이 동작되지 않는다면 python_examples.py에 경로 확인 코드를 사용해서 작업 경로를 확인해주길 바라미....
...
실험 결과
    ...
    * 옵션 <번호>: 처리속도(초), 파일 크기
    * JPEG는 손실압축이므로 설정 옵션에 따라 해상도가 매우 크게 바뀜! 
    옵션 0:  처리속도 0.03609418869018555, 41.2KB, 
    옵션 10: 처리속도 0.03709769248962402, 69.7KB
    옵션 20: 처리속도 0.03910684585571289, 99.6KB
    옵션 30: 처리속도 0.0381011962890625, 125.6KB
    옵션 40: 처리속도 0.0411076545715332, 148.2KB
    옵션 50: 처리속도 0.042112112045288086, 170.4KB
    옵션 60: 처리속도 0.04311490058898926, 194.6KB
    옵션 70: 처리속도 0.045119524002075195, 232.4KB
    옵션 80: 처리속도 0.04812812805175781, 291.0KB
    옵션 90: 처리속도 0.052138328552246094, 429.2KB
    옵션 100: 처리속도 0.08522629737854004, 1.2MB
"""
